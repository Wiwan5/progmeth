	...
	public void draw(GraphicsContext gc, double x, double y) {
		...
		if (state == CAN_CHOP) {
			if(timeToChopped>=65&&timeToChopped<=70) {
				gc.drawImage(ResourseLoader.meat[7],  x-30, y-60,55, 50);
			}
			else if(timeToChopped>=55&&timeToChopped<65) {
				gc.drawImage(ResourseLoader.meat[6],  x-30, y-60,55, 50);
			}
			else if(timeToChopped>=50&&timeToChopped<55) {
				gc.drawImage(ResourseLoader.meat[5], x-30, y-60,55, 50);
			}
			else if(timeToChopped>=40&&timeToChopped<50) {
				gc.drawImage(ResourseLoader.meat[4],  x-30, y-60,55, 50);
			}
			else if(timeToChopped>=30&&timeToChopped<40) {
				gc.drawImage(ResourseLoader.meat[3],  x-30, y-60,55, 50);
			}
			else if(timeToChopped>=20&&timeToChopped<30) {
				gc.drawImage(ResourseLoader.meat[2], x-30, y-60,55, 50);
			}
			else if(timeToChopped>=10&&timeToChopped<20) {
				gc.drawImage(ResourseLoader.meat[1],  x-30, y-60,55, 50);
			}
			else if(timeToChopped>=0&&timeToChopped<10) {
				gc.drawImage(ResourseLoader.meat[0], x-30, y-60,55, 50);
			...
			if(timeToRipened>=0&&timeToRipened<240) {
				gc.drawImage(ResourseLoader.meat[0],  x-25, y-60,50, 45);
			}
			else if(timeToRipened>=240&&timeToRipened<600) {
				gc.drawImage(ResourseLoader.meat[8], x-25, y-60,50, 45);
			}
			else if(timeToRipened>=600&&timeToRipened<=720) {
				gc.drawImage(ResourseLoader.meat[9],  x-25, y-60,50, 45);
			}
